        ...
        <div className="mx-auto grid w-full max-w-[1600px] grid-cols-[1.1fr_0.9fr] items-center gap-10 max-lg:grid-cols-1 max-lg:gap-[60px] max-lg:text-center">
            <div>
                ...
                <div className="mt-9 flex gap-5 max-md:flex-col max-md:items-center">
                    <a href="Prem_Kumar- resume_.pdf" download className="rounded-full bg-red-500 px-8 py-3.5 text-sm text-white transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-500/60">Download CV</a>
            ...
            <div className="relative flex justify-center">
                <Image className="w-[560px] max-w-full rounded-[20px] opacity-0 animate-[hero-img_1s_ease_0.5s_forwards]" src="/assets/myprofile.webp" alt="Prem Jha" width="1120" height="720" loading="eager" fetchPriority="high" style={{ height: 'auto' }} />
            </div>
        </div>
    </section>
}
