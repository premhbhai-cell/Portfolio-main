...
const projects = [
    { image: '/assets/bussines1.webp', alt: 'business', title: 'Business Website', description: 'Real estate business website with property listings and responsive UI.', tags: ['HTML', 'CSS', 'JavaScript'], links: [['Project 1', 'https://premhbhai-cell.github.io/Real-state-Bussiness-Website/'], ['Project 2', 'https://premhbhai-cell.github.io/Golden-color-theme-real-state-website/']] },
    { image: '/assets/portfolio.webp', alt: 'portfolio', title: 'Portfolio Website', description: 'Modern developer portfolio website to showcase projects and skills.', tags: ['HTML', 'CSS', 'Responsive'], links: [['Project 1', 'https://premhbhai-cell.github.io/Portfolio/']] },
    ...
    { image: '/assets/digital-marketing.webp', alt: 'marketing', title: 'Digital Marketing Website', description: 'SEO and digital marketing agency website with lead generation layout.', tags: ['SEO', 'Marketing', 'Landing Page'], links: [['Project 1', 'https://optirank.in/']] },
    { image: '/assets/coaching-web.webp', alt: 'coaching website', title: 'Coaching Website', description: 'Professional coaching website with course sections, responsive layout and user-friendly interface.', tags: ['HTML', 'CSS', 'Responsive'], links: [['Live Project', 'https://coachinga.netlify.app/']] },
]
